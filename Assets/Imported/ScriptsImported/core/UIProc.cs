...
public class UIProc : MonoBehaviour
{
    ...
    [SerializeField]
    private WndMainMenu m_mainMenu;

    [SerializeField]
    private WndGameOver m_wndGameOver;

    [SerializeField]
    private wndGameWin m_wndGameWin;

    [SerializeField]
    private WndRateUS m_wndRateUS;

    [SerializeField]
    private wndMessage m_msg;

    [SerializeField]
    private BannerCover m_bannerCover;

    int m_txtDebugLines = 0;

    public static UIProc Instance { get; private set; }
    ...
    public void onClickNext()
    {
        ...
        //m_gameUI.UpdateUITimer(Stats.Instance.scores);
    ...
    public BannerCover GetBannerCover { get => m_bannerCover; }
}
