...
public class ADs
{
    ...
    static public void onBannerLoaded(string adSource)
    {
        ...
        Analytics.SendEvent("AdImpression", "ad_type", "banner", "day", Stats.Instance.DaysFromStart(), "counter", c);
    ...
    static public void onInterstitialCompleted(string adSource)
    {
        ...
        Analytics.SendEvent("AdImpression", "ad_type", "interstitial", "day", Stats.Instance.DaysFromStart(), "counter", c);
    ...
    static public void onRewardedCompleted(string adSource)
    {
        ...
        Analytics.SendEvent("AdImpression", "ad_type", "rewarded", "day", Stats.Instance.DaysFromStart(), "counter", c);
